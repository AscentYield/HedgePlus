...
import "@openzeppelin/contracts-upgradeable/interfaces/IERC5313Upgradeable.sol";
 ...
 * @notice This contract is a simplified alternative to OpenZeppelin's AccessControlDefaultAdminRules, adapted for upgradeability
 */
    ...
    AccessControlUpgradeable 
{
    ...
    function __SingleAdminAccessControl_init(address initialAdmin) internal initializer {
        __AccessControl_init();
        _currentDefaultAdmin = initialAdmin;
    ...
    uint256[48] private __gap; // 为未来可能的存储变量预留空间
}